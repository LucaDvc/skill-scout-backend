...
urlpatterns = [
    ...
    path('courses/<uuid:course_id>/reviews/', views.CourseReviewsListView.as_view(), name='course-reviews-list'),
    ...
    path('wishlist/', views.get_wishlist, name='catalog-view-wishlist'),
